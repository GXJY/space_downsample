...
class KD_TREE {
 ...
 public:
  ...
  int size();
  int validnum();
  void root_alpha(float &alpha_bal, float &alpha_del);  // NOLINT
  ...
  void Box_Search(const BoxPointType &Box_of_Point,
                  PointVector &Storage);  // NOLINT
  void Radius_Search(PointType point, const float radius,
                     PointVector &Storage);                     // NOLINT
  int Add_Points(PointVector &PointToAdd, bool downsample_on);  // NOLINT
  void Add_Point_Boxes(vector<BoxPointType> &BoxPoints);        // NOLINT
  void Delete_Points(PointVector &PointToDel);                  // NOLINT
  int Delete_Point_Boxes(vector<BoxPointType> &BoxPoints);      // NOLINT
  void flatten(KD_TREE_NODE *root, PointVector &Storage,        // NOLINT
               delete_point_storage_set storage_type);
  void acquire_removed_points(PointVector &removed_points);  // NOLINT
